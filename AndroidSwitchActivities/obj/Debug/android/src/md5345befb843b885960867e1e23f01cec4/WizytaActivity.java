...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AndroidSwitchActivities.WizytaActivity, AndroidSwitchActivities, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", WizytaActivity.class, __md_methods);
	}


	public WizytaActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == WizytaActivity.class)
			mono.android.TypeManager.Activate ("AndroidSwitchActivities.WizytaActivity, AndroidSwitchActivities, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
